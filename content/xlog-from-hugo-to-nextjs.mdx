...
しかし、自分はプログラミング言語の Go がすごく嫌いで、Hugo は Go で書かれているのですごく嫌な気持ちでした。
...
<img
  src="https://res.cloudinary.com/xlog/image/upload/v1/2024/03/26/uptime-downtime-details-ss?_a=BAMHUyJt0"
  alt="Cloudinary image<uptime-downtime-details-ss.png-2024/03/26/uptime-downtime-details-ss>"
/>
