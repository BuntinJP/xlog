...
date: 2025-01-12
tags: ['ArchLinux','postfix','dovecot', 'SendGrid']
...
![05_build-mailserver-with-sendgrid-arch/sendgrid-01](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-01.webp?_a=BAMHUyJu0)
![05_build-mailserver-with-sendgrid-arch/sendgrid-02](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-02.webp?_a=BAMHUyJu0)
...
![05_build-mailserver-with-sendgrid-arch/sendgrid-03](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-03.webp?_a=BAMHUyJu0)
![05_build-mailserver-with-sendgrid-arch/sendgrid-04](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-04.webp?_a=BAMHUyJu0)

Fromヘッダーのドメインを入力して進みます。これは、エンベロープFromではなく、Fromヘッダーのドメイン部分です。

![05_build-mailserver-with-sendgrid-arch/sendgrid-05](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-05.webp?_a=BAMHUyJu0)


レジストラを選択する画面でCloudflareの選択肢があったので、自動でやってくれるのかと思ったのですが、手動なようです。
言われるがままレコードをセットアップします。

![05_build-mailserver-with-sendgrid-arch/sendgrid-06](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-06.webp?_a=BAMHUyJu0)
...
![05_build-mailserver-with-sendgrid-arch/sendgrid-07](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-07.webp?_a=BAMHUyJu0)

![05_build-mailserver-with-sendgrid-arch/sendgrid-09](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/sendgrid-09.webp?_a=BAMHUyJu0)
...
![05_build-mailserver-with-sendgrid-arch/test-01-thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/test-01-thunderbird.webp?_a=BAMHUyJu0)
...
![05_build-mailserver-with-sendgrid-arch/test-02-thunderbird2gmail](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/test-02-thunderbird2gmail.webp?_a=BAMHUyJu0)

![05_build-mailserver-with-sendgrid-arch/test-03-gmail](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/test-03-gmail.webp?_a=BAMHUyJu0)

gmailで受信が確認できたら、gmailからメールを送信し受信を検証します。

![05_build-mailserver-with-sendgrid-arch/test-04-gmail2thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/test-04-gmail2thunderbird.webp?_a=BAMHUyJu0)
![05_build-mailserver-with-sendgrid-arch/test-05-thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/test-05-thunderbird.webp?_a=BAMHUyJu0)
...
![05_build-mailserver-with-sendgrid-arch/result-virtual-domain](https://res.cloudinary.com/xlog/image/upload/v1/05_build-mailserver-with-sendgrid-arch/result-virtual-domain.webp?_a=BAMHUyJu0)
OKですね。
