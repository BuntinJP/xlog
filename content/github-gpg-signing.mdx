...
description: Githubで、コミットにGPG鍵で署名できるようにするための設定方法です。githubのコミットログに「Verified」と表示されるようになります。
date: 2024-03-01
...
![02_github-gpg-signing/github-gpg-signing-result](/images/02_github-gpg-signing/github-gpg-signing-result.webp)
