...
![2024/12/05/sendgrid-01](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-01.webp?_a=BAMHUyJu0)
![2024/12/05/sendgrid-02](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-02.webp?_a=BAMHUyJu0)
#### 4.2 送信ドメイン認証

Setting > Sender Authentication > Domain Authentication  
と進みます。

![2024/12/05/sendgrid-03](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-03.webp?_a=BAMHUyJu0)
![2024/12/05/sendgrid-04](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-04.webp?_a=BAMHUyJu0)

Fromヘッダーのドメインを入力して進みます。これは、エンベロープFromではなく、Fromヘッダーのドメイン部分です。

![2024/12/05/sendgrid-05](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-05.webp?_a=BAMHUyJu0)


レジストラを選択する画面でCloudflareの選択肢があったので、自動でやってくれるのかと思ったのですが、手動なようです。
言われるがままレコードをセットアップします。

![2024/12/05/sendgrid-06](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-06.webp?_a=BAMHUyJu0)
...
![2024/12/05/sendgrid-07](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-07.webp?_a=BAMHUyJu0)

![2024/12/05/sendgrid-09](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/sendgrid-09.webp?_a=BAMHUyJu0)
...
![2024/12/05/test-01-thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/test-01-thunderbird.webp?_a=BAMHUyJu0)
...
![2024/12/05/test-02-thunderbird2gmail](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/test-02-thunderbird2gmail.webp?_a=BAMHUyJu0)

![2024/12/05/test-03-gmail](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/test-03-gmail.webp?_a=BAMHUyJu0)

gmailで受信が確認できたら、gmailからメールを送信し受信を検証します。

![2024/12/05/test-04-gmail2thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/test-04-gmail2thunderbird.webp?_a=BAMHUyJu0)
![2024/12/05/test-05-thunderbird](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/test-05-thunderbird.webp?_a=BAMHUyJu0)
...
![2024/12/05/result-virtual-domain](https://res.cloudinary.com/xlog/image/upload/v1/2024/12/05/result-virtual-domain.webp?_a=BAMHUyJu0)
